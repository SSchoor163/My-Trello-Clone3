...
export class TodoService {
  todoList:ITodo [] = [
  {Id: 1, Title: "First Todo Item", CreationDate: new Date("2019-07-01"), Backlog: false, Working: false, Complete: true},
  {Id: 2, Title: "Second Todo Item", CreationDate: new Date("2019-07-02"),  DueDate: new Date(), Backlog: false, Working: true, Complete: false},
  {Id: 3, Title: "Third Todo Item", CreationDate: new Date("2019-07-03"), DueDate: new Date("2019-11-03"), Backlog: true, Working: false, Complete: false}];
  constructor() { }

  getTodoItems(lane:string)
  {
    if(lane ==="Backlog")
    {
